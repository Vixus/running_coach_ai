...
- 002-feature-athlete-timezone: Added Python 3.11 + `timezonefinder>=6.0.0` (new), `APScheduler 3.x` (existing), `SQLAlchemy` (existing), `garminconnect`/`garth` (existing), `slack-bolt` (existing)
